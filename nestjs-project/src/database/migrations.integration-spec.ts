...
import { CreateVideos1789513812451 } from './migrations/1789513812451-CreateVideos';
...
describe('Database migrations (integration)', () => {
  ...
  beforeAll(async () => {
    ...
    // Drop tables first (CASCADE handles FKs), then the enum types. Sequential
    // order avoids the "type already exists" / deadlock races that parallel
    // drops of a table and its enum type produce.
